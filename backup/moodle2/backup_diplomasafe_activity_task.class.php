...
class backup_diplomasafe_activity_task extends backup_activity_task {
    ...
    static public function encode_content_links($content) {
        ...
        $search="/(".$base."\//mod\/diplomasafe\/index.php\?id\=)([0-9]+)/";
        $content= preg_replace($search, '$@DIPLOMASAFEINDEX*$2@$', $content);

        // Link to choice view by moduleid
        $search="/(".$base."\//mod\/diplomasafe\/view.php\?id\=)([0-9]+)/";
        $content= preg_replace($search, '$@DIPLOMASAFEVIEWBYID*$2@$', $content);
